...
class Pedido 
{
        ...
        async getPedidoByNit(nit) {
            let results = await db.query('SELECT * FROM pedido WHERE nit = $1', [nit]).catch(console.log); 
            return results.rows;
        }
